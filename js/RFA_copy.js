$(function () {
    ...
    $('#smith-input-parameters').off('submit').on('submit', function (e) {
        ...
        function main() {
            ...
            $('#Load-CL-Result').html('CL = ' + CL.re.toFixed(4) + (CL.im > 0 ? " + " : " - ") + "j" + Math.abs(CL.im).toFixed(4));
            $('#Load-RL-Result').html('RL = ' + RL.toFixed(4));
            $('#Load-CS-Result').html('CS = ' + CS.re.toFixed(4) + (CS.im > 0 ? " + " : " - ") + "j" + Math.abs(CS.im).toFixed(4));
            ...
            if (Dir === 1) {
                ...
                for (var i = 1; i <= 4; i++) {
                    if (!isNaN(GSdb[i]) && !isNaN(GLdb[i])) {
                        ...
                        $('#Cs-stable-Result').append('\$CS' + i + ' = ' + CSt[i].re.toFixed(4) + (CSt[i].im > 0 ? " + " : " - ") + "j" + Math.abs(CSt[i].im).toFixed(4)+'&deg;\$<br>');
                        $('#Rs-stable-Result').append('\$RS' + i + ' = ' + RSt[i].toFixed(4) + '\$<br>');
                        ...
                        $('#CL-stable-Result').append('\$CL' + i + ' = ' + CLt[i].re.toFixed(4) + (CLt[i].im > 0 ? " + " : " - ") + "j" + Math.abs(CLt[i].im).toFixed(4)+'&deg;\$<br>');
                        $('#RL-stable-Result').append('\$RL' + i + ' = ' + RLt[i].toFixed(4) + '\$<br>');
                ...
                $('.gS-res').append('<br>\$\\Gamma_S =\$ ' + (GSj.re).toFixed(4) + '' + (GSj.im >= 0 ? ' + j' : ' - j') + Math.abs(GSj.im).toFixed(4) + ' = ' + GSj.abs().toFixed(4) + ' &ang; ' + (GSj.arg() * 180 / Math.PI).toFixed(4) + '&deg;');
                ...
                $('.gL-res').html('\$\\Gamma_L = \$ ' + (GLj.re).toFixed(4) + '' + (GLj.im >= 0 ? ' + j' : ' - j') + Math.abs(GLj.im).toFixed(4) + ' = ' + GLj.abs().toFixed(4) + ' &ang; ' + (GLj.arg() * 180 / Math.PI).toFixed(4) + '&deg;');
            ...
            if (Dir === 2) {
                ...
                $('#Cp-stable-Result').html('Cp = ' + Cp.re.toFixed(4) + (Cp.im > 0 ? " + " : " - ") + "j" + Math.abs(Cp.im).toFixed(4) + ' = ' + mCp.toFixed(4) + ' &ang; ' + argCp.toFixed(4) + '&deg;');
                $('#Rp-stable-Result').html('Rp = ' + Rp.toFixed(4));
                ...
                $('.gL-res').html('\$\\Gamma_L = \$ ' + (GL.X()).toFixed(4) + '' + (GL.Y() >= 0 ? ' + j' : ' - j') + Math.abs(GL.Y()).toFixed(4) + ' = ' + GLj.abs().toFixed(4) + ' &ang; ' + (GLj.arg() * 180 / Math.PI).toFixed(4) + '&deg;');
